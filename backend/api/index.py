...
Supports deployment both from the repository root (as a subfolder)
and directly from the backend folder itself.
"""
import sys
import os
import json
...
# ── Path setup ────────────────────────────────────────────────────
# Ensure the backend directory is in sys.path so "from main import app" works
